...
public class StudentManagement {
    public static void main(String[] args) {
        ...
        Collections.sort(stuObj, Comparator.comparingInt(Student::getMarks).reversed());// Soting Students in descending order based on marks
        ...
        while (!exit) {
            ...
            try {
                ...
                System.out.println("Only Integer allowed" + e);
                break;
            }
            String name = "";
            switch (n) {
                ...
                case 4:
                    ...
                    for(int i= 0;i<=2;i++){
                        System.out.println(stuObj.get(i));
                    }
